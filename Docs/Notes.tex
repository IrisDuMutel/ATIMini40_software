...
This is why filters are also a scope of this study. The F/T sensor we are currently using provides unfiltered analog data that is sampled through a DAQ, and therefore transformed into digital information. However, this digital data stream may contain noise from vibration, EM interferences...
