...
file1 = '../LogFiles/SensorComparison/Individual/JR3_test500g_My.csv'; %LoadCell
file2 = '../LogFiles/SensorComparison/Individual/ATI_test100g_My.csv'; %LoadCell
...
filtered_My2 = 1*filter(b_5, a_5,My2);
