...
file1 = '../LogFiles/SensorComparison/Individual/JR3_test500g_Fz.csv'; %LoadCell
file2 = '../LogFiles/SensorComparison/Individual/ATI_test500g_Fz.csv'; %LoadCell

weight= [500e-3;500e-3];%kg
g = 9.80665; %m/s² 
