...
rel_err1 = abs((Mx1_avg-M_expected(1))/F_expected(1))*100;
rel_err2 = abs((Mx2_avg-M_expected(2))/F_expected(2))*100;
rel_err3 = abs((Mx3_avg-M_expected(3))/F_expected(3))*100;
rel_err4 = abs((Mx4_avg-M_expected(4))/F_expected(4))*100;
rel_err5 = abs((Mx5_avg-M_expected(5))/F_expected(5))*100;
rel_err6 = abs((Mx6_avg-M_expected(6))/F_expected(6))*100;
rel_err7 = abs((Mx7_avg-M_expected(7))/F_expected(7))*100;
