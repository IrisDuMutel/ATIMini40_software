...
rel_err1 = abs((My1_avg_ATI-M_expected_ATI(1))/M_expected_ATI(1))*100;
rel_err2 = abs((My2_avg_ATI-M_expected_ATI(2))/M_expected_ATI(2))*100;
rel_err3 = abs((My3_avg_ATI-M_expected_ATI(3))/M_expected_ATI(3))*100;
rel_err4 = abs((My4_avg_ATI-M_expected_ATI(4))/M_expected_ATI(4))*100;
rel_err5 = abs((My5_avg_ATI-M_expected_ATI(5))/M_expected_ATI(5))*100;
rel_err6 = abs((My6_avg_ATI-M_expected_ATI(6))/M_expected_ATI(6))*100;
rel_err7 = abs((My7_avg_ATI-M_expected_ATI(7))/M_expected_ATI(7))*100;
...
abs_err1 = abs((My1_avg_ATI-M_expected_ATI(1)));
abs_err2 = abs((My2_avg_ATI-M_expected_ATI(2)));
abs_err3 = abs((My3_avg_ATI-M_expected_ATI(3)));
abs_err4 = abs((My4_avg_ATI-M_expected_ATI(4)));
abs_err5 = abs((My5_avg_ATI-M_expected_ATI(5)));
abs_err6 = abs((My6_avg_ATI-M_expected_ATI(6)));
abs_err7 = abs((My7_avg_ATI-M_expected_ATI(7)));
...
%% JR3
file1 = '../../LogFiles/SensorComparison/Individual/log20221012_test72g1mg_My.csv'; %LoadCell
file2 = '../../LogFiles/SensorComparison/Individual/log20221012_test72g3mg_My.csv'; %LoadCell
file3 = '../../LogFiles/SensorComparison/Individual/log20221012_test72g6mg_My.csv'; %LoadCell
file4 = '../../LogFiles/SensorComparison/Individual/log20221012_test73g2mg_My.csv'; %LoadCell
file5 = '../../LogFiles/SensorComparison/Individual/log20221012_test73g5mg_My.csv'; %LoadCell
file6 = '../../LogFiles/SensorComparison/Individual/log20221012_test73g7mg_My.csv'; %LoadCell
file7 = '../../LogFiles/SensorComparison/Individual/log20221012_test500g_My.csv'; %LoadCell
...
rel_err1 = abs((My1_avg_JR3-M_expected_JR3(1))/M_expected_JR3(1))*100;
rel_err2 = abs((My2_avg_JR3-M_expected_JR3(2))/M_expected_JR3(2))*100;
rel_err3 = abs((My3_avg_JR3-M_expected_JR3(3))/M_expected_JR3(3))*100;
rel_err4 = abs((My4_avg_JR3-M_expected_JR3(4))/M_expected_JR3(4))*100;
rel_err5 = abs((My5_avg_JR3-M_expected_JR3(5))/M_expected_JR3(5))*100;
rel_err6 = abs((My6_avg_JR3-M_expected_JR3(6))/M_expected_JR3(6))*100;
rel_err7 = abs((My7_avg_JR3-M_expected_JR3(7))/M_expected_JR3(7))*100;
rel_err = [rel_err1,rel_err2,rel_err3,rel_err4,rel_err5,rel_err6,rel_err7]'
avg_relErr = mean([rel_err1,rel_err2,rel_err3,rel_err4,rel_err5,rel_err6,rel_err7]);
fprintf('The JR3 average relative error is: %f \n', avg_relErr)
abs_err1 = abs((My1_avg_JR3-M_expected_JR3(1)));
abs_err2 = abs((My2_avg_JR3-M_expected_JR3(2)));
abs_err3 = abs((My3_avg_JR3-M_expected_JR3(3)));
abs_err4 = abs((My4_avg_JR3-M_expected_JR3(4)));
abs_err5 = abs((My5_avg_JR3-M_expected_JR3(5)));
abs_err6 = abs((My6_avg_JR3-M_expected_JR3(6)));
abs_err7 = abs((My7_avg_JR3-M_expected_JR3(7)));
abs_err = [abs_err1,abs_err2,abs_err3,abs_err4,abs_err5,abs_err6,abs_err7]'
avg_absErr = mean([abs_err1,abs_err2,abs_err3,abs_err4,abs_err5,abs_err6,abs_err7]);
...
t = tiledlayout(1,1);
ax1 = axes(t);
plot(ax1,M_expected_ATI(1), My1_avg_ATI,'o', 'lineWidth',2,'color','b')
hold on
plot(ax1,M_expected_ATI(2), My2_avg_ATI,'o', 'lineWidth',2,'color','b')
plot(ax1,M_expected_ATI(3), My3_avg_ATI,'o', 'lineWidth',2,'color','b')
plot(ax1,M_expected_ATI(4), My4_avg_ATI,'o', 'lineWidth',2,'color','b')
plot(ax1,M_expected_ATI(5), My5_avg_ATI,'o', 'lineWidth',2,'color','b')
plot(ax1,M_expected_ATI(6), My6_avg_ATI,'o', 'lineWidth',2,'color','b')
plot(ax1,M_expected_ATI(7), My7_avg_ATI,'o', 'lineWidth',2,'color','b')
ax1.XAxisLocation = 'bottom';
ax1.YAxisLocation = 'left';
ylabel('Measured ATI value M_y [N\cdot m]')
xlabel('True Value [N\cdot m]')
% legend('','','','','','','ATI')
ax1.XColor = 'b';
ax1.YColor = 'b';
ax2 = axes(t);
plot(ax2, M_expected_JR3(1), My1_avg_JR3,'o', 'lineWidth',2,'color','k')
hold on
plot(ax2, M_expected_JR3(2), My2_avg_JR3,'o', 'lineWidth',2,'color','k')
plot(ax2, M_expected_JR3(3), My3_avg_JR3,'o', 'lineWidth',2,'color','k')
plot(ax2, M_expected_JR3(4), My4_avg_JR3,'o', 'lineWidth',2,'color','k')
plot(ax2, M_expected_JR3(5), My5_avg_JR3,'o', 'lineWidth',2,'color','k')
plot(ax2, M_expected_JR3(6), My6_avg_JR3,'o', 'lineWidth',2,'color','k')
plot(ax2, M_expected_JR3(7), My7_avg_JR3,'o', 'lineWidth',2,'color','r')
ax2.XAxisLocation = 'top';
ax2.YAxisLocation = 'right';
ax2.Color = 'none';
ax1.Box = 'off';
ax2.Box = 'off';
ylabel('Measured JR3 value M_y [N\cdot m]')
% legend('','','','','','JR3')
% xlabel('True Value [N\cdot m]')
title(Title)
grid on
