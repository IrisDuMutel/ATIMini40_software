...
with nidaqmx.Task() as task:
    task.di_channels.add_di_chan("Dev3/port0/line0", line_grouping=LineGrouping.CHAN_PER_LINE)
    ...
    task.di_channels.add_di_chan("Dev3/port0/line0:3", line_grouping=LineGrouping.CHAN_PER_LINE)
